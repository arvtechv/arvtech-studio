  ...
  return (
    ...
    >
      <style>{`
        ...
        .service-card:hover { transform: translateY(-6px) !important; box-shadow: 0 20px 40px -10px rgba(255, 85, 0, 0.15) !important; border-color: rgba(255, 85, 0, 0.4) !important; }
        .project-card { transition: transform 0.3s ease, box-shadow 0.3s ease, border-color 0.3s ease; background: #FFFFFF; }
        .project-card:hover { transform: translateY(-6px) !important; box-shadow: 0 20px 40px -10px rgba(15, 23, 42, 0.1) !important; border-color: #FF5500 !important; }
        .value-card { transition: transform 0.3s ease, border-color 0.3s ease, box-shadow 0.3s ease; background: #FFFFFF; }
        .value-card:hover { transform: translateY(-4px); border-color: #FF5500 !important; box-shadow: 0 12px 30px rgba(255, 85, 0, 0.12) !important; }
        .cta-btn { transition: all 0.3s ease; cursor: pointer; }
        .cta-btn:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(255, 85, 0, 0.35) !important; }
        .category-tab { transition: all 0.25s ease; cursor: pointer; }
        .category-tab:hover { border-color: #FF5500 !important; color: #FF5500 !important; }
